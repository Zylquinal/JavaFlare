...
import com.zylquinal.cflare.data.firewall.other.CreateAccessRuleResult;
import lombok.Getter;
import lombok.Setter;

@Getter
@Setter
public class CreateAccessRuleResponse extends ResponseCommon {

    private CreateAccessRuleResult result;
